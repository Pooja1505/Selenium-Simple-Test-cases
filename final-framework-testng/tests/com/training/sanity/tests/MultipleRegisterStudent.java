...
public class MultipleRegisterStudent {
	private static WebDriver driver;
	private static Properties properties;
	private static ScreenShot screenShot;
	private static String baseUrl;
	private static MultipleRegisterStudent MultipleRegisterStudent;
	...
	public static void setUpBeforeClass() throws IOException {
		...
		MultipleRegisterStudent = new MultipleRegisterStudent();
	...
	public void signUp() throws InterruptedException {
		...
		for (int i = 2; i < as.length; i++) {
			...
			screenShot.captureScreenShot("Register Multiple Student"+i);
